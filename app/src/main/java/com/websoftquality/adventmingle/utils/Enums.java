package com.websoftquality.adventmingle.utils;
/**
...
public class Enums {
    public static final String MY_PHONE_NUMBER = "com.websoftquality.adventmingle.views.signup.PhoneNumberFragment";
    public static final String ONE_TIME_PWD = "com.websoftquality.adventmingle.views.signup.OneTimePwdFragment";
    public static final String GENDER = "com.websoftquality.adventmingle.views.signup.GenderFragment";
    public static final String FIRST_NAME = "com.websoftquality.adventmingle.views.signup.FirstNameFragment";
    public static final String LAST_NAME = "com.websoftquality.adventmingle.views.signup.LastNameFragment";
    public static final String PASSWORD = "com.websoftquality.adventmingle.views.signup.PasswordFragment";
    public static final String BIRTHDAY = "com.websoftquality.adventmingle.views.signup.BirthdayFragment";
    public static final String EMAIL = "com.websoftquality.adventmingle.views.signup.EmailFragment";
    public static final String PROFILE_PICK = "com.websoftquality.adventmingle.views.signup.ProfilePickFragment";
