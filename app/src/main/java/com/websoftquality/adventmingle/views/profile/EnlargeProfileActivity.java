package com.websoftquality.adventmingle.views.profile;
/**
...
import com.websoftquality.adventmingle.datamodels.chat.ChatMessageModel;
import com.websoftquality.adventmingle.datamodels.chat.ReasonModel;
import com.websoftquality.adventmingle.datamodels.chat.UnMatchReasonModel;
import com.websoftquality.adventmingle.datamodels.main.JsonResponse;
import com.websoftquality.adventmingle.datamodels.main.MyProfileModel;
import com.websoftquality.adventmingle.interfaces.ApiService;
import com.websoftquality.adventmingle.interfaces.DropDownClickListener;
...
import com.websoftquality.adventmingle.utils.Enums;
import com.websoftquality.adventmingle.utils.ImageUtils;
import com.websoftquality.adventmingle.utils.RequestCallback;
import com.websoftquality.adventmingle.views.customize.CirclePageIndicator;
import com.websoftquality.adventmingle.views.customize.CustomDialog;
import com.websoftquality.adventmingle.views.customize.CustomLayoutManager;
import com.websoftquality.adventmingle.views.customize.CustomRecyclerView;
import com.websoftquality.adventmingle.views.customize.IgniterViewPager;

import static com.websoftquality.adventmingle.utils.Enums.MATCH_LIKE;
import static com.websoftquality.adventmingle.utils.Enums.MATCH_NOPE;
import static com.websoftquality.adventmingle.utils.Enums.MATCH_SUPER_LIKE;
import static com.websoftquality.adventmingle.utils.Enums.REQ_GET_OTHER_PROFILE;
import static com.websoftquality.adventmingle.utils.Enums.REQ_REPORT_DETAILS_PROFILE;
import static com.websoftquality.adventmingle.utils.Enums.REQ_SWIPE_ENLARGE;
...
public class EnlargeProfileActivity extends AppCompatActivity implements View.OnClickListener, ServiceListener, UnmatchReasonListAdapter.OnItemClickListener {
    ...
    private void initView() {
        ...
        tvLikedUserIcon = findViewById(R.id.tv_liked_user_icon);
        tvShareIcon = findViewById(R.id.tv_share_icon);
        tvMenuIcon = findViewById(R.id.tv_menu_icon);
        rltReportUser = findViewById(R.id.rlt_report_user);

        rltLike = findViewById(R.id.rlt_like_lay);
        rltSuperLike = findViewById(R.id.rlt_superlike_lay);
        rltUnLike = findViewById(R.id.rlt_unlike_lay);
        rtl_arrow_down = findViewById(R.id.rtl_arrow_down);
        tvEditProfileIcon = findViewById(R.id.tv_profile_edit_icon);

        tvUserNameAge = findViewById(R.id.tv_user_name_age);
        tvDesignation = findViewById(R.id.tv_designation);
        tvProfession = findViewById(R.id.tv_profession);
        tvLocation = findViewById(R.id.tv_location);
        tvAbout = findViewById(R.id.tv_about_user);

        tvRecommendFriend = findViewById(R.id.tv_friends_count);
        tvRecommendDescription = findViewById(R.id.tv_friends_description);
        tvConnectedFriend = findViewById(R.id.tv_connect_friends);
        tvToFriend = findViewById(R.id.tv_to_friends);
        tvReportUser = findViewById(R.id.tv_report_user);

        lltDesignation = findViewById(R.id.llt_designation);
        lltProfession = findViewById(R.id.llt_profession);
        lltLocation = findViewById(R.id.llt_location);
        lltAbout = findViewById(R.id.llt_about);
        lltRecommend = findViewById(R.id.llt_recommend);
        lltConnectFriends = findViewById(R.id.llt_connect_friends);
        rltBottomIcon = findViewById(R.id.rlt_bottom_icons);
    ...
    public void showUnMatchDialog(String title, String message, int type, ArrayList<ReasonModel> reasonModel) {
        ...
        mSceneRoot = unMatchDialog.findViewById(R.id.scene_root);
    ...
    private void getUnMatchReason() {
        ...
        edtInfo = mSceneRoot.findViewById(R.id.edt_info);
