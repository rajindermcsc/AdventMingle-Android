...
public class SettingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMaxDistance.setText(String.format(getString(R.string.kilometer), sessionManager.getDistance()));
    ...
    private void initSeekBarChangeListener() {
        sbMaxDistance.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                tvMaxDistance.setText(String.format(getString(R.string.kilometer), String.valueOf(progress)));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.tv_license:
                loadUrl("http://adventmingle.com//about");
                break;
            case R.id.cv_help_support:
                loadUrl("http://adventmingle.com//contact");
                break;
            case R.id.tv_privacy_policy:
                loadUrl("http://adventmingle.com//privacy");
                break;
            case R.id.tv_terms_service:
                loadUrl("http://adventmingle.com//terms");
                break;
