...
-keep public class com.websoftquality.adventmingle.datamodels.** {*;}
-keep class com.websoftquality.adventmingle.views.main.LoginActivity
-keep class com.websoftquality.adventmingle.utils.** {*;}
-keepclasseswithmembernames class com.websoftquality.adventmingle.utils.** {*;}
